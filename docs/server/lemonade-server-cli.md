...
| `--save-images`                | Save generated images to disk instead of cleaning up after returning base64 response. Useful for debugging or keeping generated images. | False |
| `--images-dir [path]`          | Directory to save generated images when `--save-images` is enabled. | `./generated_images` |
