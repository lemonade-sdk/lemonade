...
To enable auto-detection by Ollama-integrated apps, configure the server to use the Ollama default port `11434`. See [Server Configuration](./configuration.md#environment-variables) for how to change the port.
