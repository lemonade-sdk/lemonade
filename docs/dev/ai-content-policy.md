...
1. Participation in the Lemonade community should be enjoyable for humans.
2. Important decisions for building Lemonade should be made by humans.
...
Contributors are encouraged to use AI coding tools, however you fully responsible for the code you submit.
