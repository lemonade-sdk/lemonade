...
- Be considerate of how much data your workflow will download.
    ...
    - Place your Lemonade home directory inside the `_work` directory so that it will be wiped after each job.
        - Example: Pass the home dir as the first argument to `lemond`: `lemond .\ci-cache`
