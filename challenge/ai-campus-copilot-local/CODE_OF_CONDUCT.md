...
For this project, "community spaces" means issues and pull requests concerning
`challenge/ai-campus-copilot-local/` in the repository
<https://github.com/JEROME-PRAKASH-L/lemonade>.

Conduct in the upstream [lemonade-sdk/lemonade](https://github.com/lemonade-sdk/lemonade)
project is governed by that project's own community standards, not this document.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to
the project maintainer by opening an issue at
<https://github.com/JEROME-PRAKASH-L/lemonade/issues>, or, where privacy is needed, via
