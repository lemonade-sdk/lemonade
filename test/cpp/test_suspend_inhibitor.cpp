...
//
// Exercises the production refcounting path via the base class by subclassing
// SuspendInhibitor and overriding on_first_acquire()/on_last_release() to track
// calls without calling any OS APIs.
