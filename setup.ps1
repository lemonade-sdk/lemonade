...
Write-Info "Verifying required build tools..."

$requiredTools = @("cmake", "ninja", "gcc", "g++")
$missingTools = @()
...
if ($missingTools.Count -gt 0) {
    ...
    Write-Info "Please install them:"
    Write-Info "  - CMake: https://cmake.org/download/"
    Write-Info "  - Ninja: https://github.com/ninja-build/ninja/releases"
    Write-Info "  - GCC/G++: Install MinGW-w64 or use MSVC from Visual Studio"
    exit 1
}
