...
Write-Host "  Build the project: cmake --build --preset windows --config Release"
Write-Host "  Build the electron app: cmake --build --preset windows --config Release --target electron-app"
Write-Host ""
