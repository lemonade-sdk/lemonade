...
const ModelManager: React.FC<ModelManagerProps> = ({ onModelSelect, openModelRequest }) => {
  ...
  }, [providerEnabled, searchQuery, primaryFilter, localRegistryRefs, remoteVariants, incompatibleHfVariantKeys, taskFilters, capabilityFilter, backendFilters, tagFilters]);
