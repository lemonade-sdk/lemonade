...
const TitleBar: React.FC<TitleBarProps> = ({ 
  ...
  // Check if running in Electron (has window controls) vs browser
  const isElectron = typeof window.api?.minimizeWindow === 'function';
    ...
    <>
      <div className="title-bar">
              ...
              {activeMenu === 'help' && (
                <div className="menu-dropdown">
                  <div className="menu-option" onClick={() => { 
                    const url = 'https://lemonade-server.ai/docs/';
                  ...
                  <div className="menu-option" onClick={() => { 
                    const url = 'https://github.com/lemonade-sdk/lemonade/releases';
                    if (window.api?.openExternal) {
                      window.api.openExternal(url);
                    } else {
                      window.open(url, '_blank');
        ...
        <div className="title-bar-right">
          ...
          {/* Window control buttons - only show in Electron */}
          {isElectron && (
            <>
              <button 
