...
const CustomCollectionPanel: React.FC<CustomCollectionPanelProps> = ({
  ...
  const validateOmni = (): CustomCollectionDraft | null => {
    ...
    if (!cleanName) { setError('Omni Model name is required.'); return null; }
    if (!omniForm.llm) { setError('Select a planner LLM for the Omni Model.'); return null; }
    return omniFormToDraft({ ...omniForm, name: cleanName });
  };
