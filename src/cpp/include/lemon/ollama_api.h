...
private:
    friend class AnthropicApiTestPeer;
    ...
    json convert_openai_chat_to_anthropic(const json& openai_response, const std::string& model, std::vector<std::string>& warnings);
