    ...
    */
    ...
    public:
        ...
        */
        ...
        /** Get the latest version number for the given recipe/variant */
        ...
        static std::string get_installed_version_file(const BackendSpec& spec, const std::string& variant);
        ...
        /** Checks the environment for a variable following the scheme LEMONADE_RECIPE_VARIANT_BIN and return its value, if available. Generally only used internally by BackendUtils */
