...
static const std::vector<std::string> USER_DEFINED_MODEL_PROPS = std::vector<std::string>{"checkpoints", "checkpoint", "recipe", "mmproj", "size", "image_defaults", "speech_defaults", "audio_defaults", "pcm_sample_rate", "pcm_channels", "components", "recipe_options", "routing", "system_prompt", "version", "source", "registry_source"};
